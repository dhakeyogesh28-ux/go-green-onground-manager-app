      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            width: double.infinity,
            child: ElevatedButton(
              onPressed: allPhotosCaptured ? _handleCheckIn : null,
              style: ElevatedButton.styleFrom(
                backgroundColor: allPhotosCaptured ? AppTheme.primaryBlue : const Color(0xFFE5E7EB),
              ...
              child: Text(
                allPhotosCaptured ? 'Proceed to Check In' : 'Capture all photos to proceed',
                style: TextStyle(
